...
export default class NativeList extends Component {
    ...
    render() {
            ...
            if (this.props.multipleSelect) {
                listComponent = ( < ItemCheckboxList items = { this.state.items }
                    ...
                    listComponent = ( < ItemList items = { this.state.items }
                        onSelect = { this.handleSelect }
                        onRemove = { this.handleRemove }
                        showCount = { this.props.showCount }
                        defaultSelected = { this.props.defaultSelected }
                    ...
                    if (this.props.showSearch) {
                        searchComponent = ( < StaticSearch placeholder = { this.props.placeholder }
                        ...
                        if (this.props.title) {
                            ...
                            return ( <
                                ...
                                style = { this.props.componentStyle } > { title } { searchComponent } { listComponent } {
